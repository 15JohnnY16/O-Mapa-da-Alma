import { Heart, User, Fingerprint } from "lucide-react";
  ...
  return (
    <section className="py-10 bg-navy-light overflow-hidden">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        {/* Depoimentos Rápidos — ocultos até ter depoimentos reais (nome, foto, idade). Trocar false por true para reativar. */}
        {false && (
        ...
        {/* --- BOX FINAL: Feito à Mão (Estilo Glassmorphism Premium) --- */}
            ...
            <div className="relative rounded-3xl border border-white/10 bg-navy/60 shadow-2xl overflow-hidden backdrop-blur-xl p-8 md:p-12 text-center transform hover:scale-[1.02] transition-transform duration-300">
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-white text-xs font-bold uppercase tracking-wider backdrop-blur-md shadow-sm">
                        <Fingerprint className="w-4 h-4 text-primary" /> Personalizada
                    </div>

                    <div className="space-y-5">
                        <h3 className="font-serif text-3xl md:text-4xl font-bold text-white leading-tight drop-shadow-sm">
                            Cada Carta é feita por mim, <br /> para Você!
                        </h3>
                        <p className="text-gray-200 max-w-2xl mx-auto text-base md:text-lg leading-relaxed drop-shadow-sm">
                            Eu leio o seu mapa e escrevo a sua Carta <strong className="text-foreground">com calma e presença</strong>. Sem texto pronto, sem fórmula. Só você.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center gap-4">
                        ...
                        <p className="text-sm text-white/60 font-medium relative z-20">
                          Gratuito. Direto no seu e-mail, em até <strong className="text-foreground">24 horas</strong>.
                        </p>
                    </div>
                </div>
            </div>
